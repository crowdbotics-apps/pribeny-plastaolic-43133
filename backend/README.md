...
## Project Structure
    ...
    ├── pribeny_plastaolic_43133  # Django project configurations
...
1. Clone this repo and `cd pribeny_plastaolic_43133`
...
2. Clone this repo and `cd pribeny_plastaolic_43133`
