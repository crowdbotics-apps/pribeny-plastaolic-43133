"""
Django settings for pribeny_plastaolic_43133 project.
...
ROOT_URLCONF = 'pribeny_plastaolic_43133.urls'
...
WSGI_APPLICATION = 'pribeny_plastaolic_43133.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pribeny_plastaolic_43133 API",
    "DESCRIPTION": "API documentation for pribeny_plastaolic_43133 App",
    "VERSION": "v1",
}
